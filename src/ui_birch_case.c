...
{
    [BALL_TOP_FIRST]        = {SPECIES_SHINX, 5, ITEM_NONE, BALL_LUXURY, NATURE_JOLLY, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_ROAR, MOVE_THUNDER_SHOCK, MOVE_NONE}, 0, 0, TRUE},
    [BALL_TOP_SECOND]       = {SPECIES_LITTEN, 5, ITEM_NONE, BALL_LUXURY, NATURE_BOLD, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_EMBER, MOVE_NONE, MOVE_NONE}, 0, 0, TRUE},
    [BALL_MIDDLE_FIRST]     = {SPECIES_PAWNIARD, 5, ITEM_LEADERS_CREST, BALL_LUXURY, NATURE_ADAMANT, 1, MON_FEMALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_SCRATCH, MOVE_FURY_CUTTER, MOVE_NONE, MOVE_NONE}, 0, 0, FALSE},

    [BALL_TOP_THIRD]        = {SPECIES_GROOKEY, 5, ITEM_NONE, BALL_LUXURY, NATURE_IMPISH, 2, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_SCRATCH, MOVE_GROWL, MOVE_NONE, MOVE_NONE}, TRUE, 0, TRUE},
    [BALL_TOP_FOURTH]       = {SPECIES_SCORBUNNY, 5, ITEM_NONE, BALL_LUXURY, NATURE_IMPISH, 2, MON_FEMALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_NONE, MOVE_NONE}, TRUE, 0, TRUE},
    [BALL_MIDDLE_THIRD]     = {SPECIES_SOBBLE, 5, ITEM_NONE, BALL_LUXURY, NATURE_IMPISH, 2, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_POUND, MOVE_GROWL, MOVE_NONE, MOVE_NONE}, TRUE, 0, TRUE},

    [BALL_MIDDLE_SECOND]    = {SPECIES_COSMOG, 5},
